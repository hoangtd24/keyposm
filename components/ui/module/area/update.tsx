...
export default function UpdateArea({ open, onClose, onRefresh, detail }: PageProps) {
    ...
    useEffect(() => {
        if (detail) {
            ...
            if (detail.brandId){
                ...
                getListChannelDropdown(detail.brandId.toString())
            }
                
            if(detail.channelId){
                detail.channelId && form.setValue("channelId", detail.channelId.toString());
            }
        }
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        setLoading(true);
        axiosWithHeaders("post", `${NEXT_PUBLIC_UPDATE_AREA_API}`, objCreate)
            .then((response) => {
