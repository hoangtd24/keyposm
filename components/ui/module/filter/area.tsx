...
import { NEXT_PUBLIC_LIST_AREA_API } from "@/config/api";
import TableArea from "@/components/ui/module/table/area";
...
export default function FilterArea() {
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        axiosWithHeaders("post", NEXT_PUBLIC_LIST_AREA_API, objSearch)
            .then((response: any) => {
