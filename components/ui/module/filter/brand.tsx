...
import TableBrand from "@/components/ui/module/table/brand";
import { PagingOptions } from 'ka-table/models';
import { defaultPaging } from '@/config';

import {
    NEXT_PUBLIC_LIST_BRAND_API
} from "@/config/api";
...
export default function FilterBrand() {
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        setLoading(true);
        axiosWithHeaders("post", NEXT_PUBLIC_LIST_BRAND_API, objSearch)
            .then((response: any) => {
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="px-0 relative group">
                                                    <Input {...field} className="w-full px-9" placeholder="Tìm kiếm thương hiệu..." />
