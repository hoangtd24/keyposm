...
import TableAssignLocation from "@/components/ui/module/table/campaign/location/assign";
import { PagingOptions } from 'ka-table/models';
import { defaultPaging } from '@/config';

import DialogImportSelected from "./list";

import {
    NEXT_PUBLIC_LIST_LOCATION_ASSIGN_API,
    // NEXT_PUBLIC_CREATE_LIST_LOCATION_CAMPAIGN
} from "@/config/api";
...
export default function FilterLocationAssign({ campaignId }: { campaignId: string }) {
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        axiosWithHeaders("post", NEXT_PUBLIC_LIST_LOCATION_ASSIGN_API, objSearch)
            .then((response: any) => {
    ...
    const onAssign = () => {
        ...
        // console.log(selectedRows)
        const listIds = _.cloneDeep(selectedRows);
