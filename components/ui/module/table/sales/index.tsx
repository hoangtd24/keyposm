...
import AssignUserSales from "@/components/ui/module/sales";
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
...
export default function TableData({ campaignId, data, paging, loading, totalRows, onChangeTablePage, onRefresh, selectedRows, onChangeSelectedRows }: TableCampaignUserProps) {
    ...
    return (
        <>
            ...
            <AssignUserSales campaignId={campaignId} open={open} onClose={() => setOpen(false)} onRefresh={onRefresh} />
            <AlertDialog open={openDel} onOpenChange={setOpenDel}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>Xác nhận?</AlertDialogTitle>
                        <AlertDialogDescription>
                            Bạn có muốn xóa nhân viên đã chọn khỏi địa điểm không ?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
