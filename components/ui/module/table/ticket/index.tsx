...
export default function TableLocation({ data, paging, loading, totalRows, onChangeTablePage, onRefresh }: TableTicketProps) {
                  ...
                  <td colSpan={props.columns.length} className="lg:hidden w-full flex-1 relative">
                    <Card className="shadow-none">
                      <CardContent className="p-2 w-full flex space-x-1 relative overflow-x-hidden">
                        <Link href={`/ticket/${props.rowData.id}`} className="absolute w-full h-full inline-block top-0 left-0">
                          &nbsp;
                        </Link>
                  ...
                  {props.columns.map((column: any) => (
                    <td className="ka-cell hidden lg:table-cell" key={column.key} style={{ height: 40, padding: 0 }}>
                      <div className={
                        ...
                        {column.field !== "action" ? (
                          <Link href={`/ticket/${props.rowData.id}`} className="inline-flex w-full h-full">
