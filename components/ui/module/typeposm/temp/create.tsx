...
type CreateTempTypePosmProps = {
    open: boolean;
    onClose: () => void;
}

export default function CreateTempTypePosm({ open, onClose }: CreateTempTypePosmProps) {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        // console.log(values);
        let objCreate:TypeDefaultItem = _.cloneDeep(values);
        objCreate.tempId = listTempPosm.length + 1;
        objCreate.manualAdd = true;
        // console.log(objCreate);
        setLoading(true);
        let listTypePosm: TypeDefaultItem[] = _.cloneDeep(listTempPosm);
        listTypePosm.push(objCreate);
        console.log(listTypePosm);
            ...
            <DialogContent className="sm:max-w-[500px] p-0">
                <div className="p-0 relative z-10">
                    <DialogHeader className="relative z-10 p-6">
                        <DialogTitle>Thêm loại posm</DialogTitle>
                    </DialogHeader>
                    <Form {...form}>
