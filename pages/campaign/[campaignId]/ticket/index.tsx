...
import FilterTicketCampaign from "@/components/ui/module/filter/ticket/campaign";
...
export default function TicketCampaign({ campaignId }: { campaignId: string }) {
  ...
  return (
    <Layout pageInfo={{
      ...
      <FilterTicketCampaign campaignId={campaignId}/>
    </Layout>
  );
}
