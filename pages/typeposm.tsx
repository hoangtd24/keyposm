...
import Filter from "@/components/ui/module/filter/typeposm";
...
export default function TypePosm() {
    ...
    return (
        <Layout
            pageInfo={{
                title: "Danh sách loại POSM",
                description: "Tạo, chỉnh sửa, quản lý loại posm.",
            }}
        >
            <Filter />
        </Layout>
